...
var ReportParser = {
  ...
  Directive: {
    ...
    parseNameFromKnownFields: function(str, nameCollection) {
      var name = '';
      ReportParser.referenceFieldNames.each(function(validName) {
        var isMatch = str.indexOf('[' + validName) === 0;
        if (isMatch) {
          name = validName;
        }
      });
    ...
    parseName: function(str) {
      ...
      name = ReportParser.parseNameFromKnownFields(str, ReportParser.referenceFieldNames);
      if (name !== '') {
        return name;
      };
      name =  ReportParser.parseNameFromKnownFields(str, ReportParser.fieldNames);
      if (name !== '') {
        return name;
      };
    ...
    createSimpledDirective: function(directiveName, options, containingDirective, containingDirectiveOptions) {
      ...
      if (isReferenceFieldDirective && !isFieldName) {
